  ...
  return (
    ...
    >
      ...
      <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
        ...
        <button
          onClick={toggleLang}
          className="group inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm backdrop-blur transition hover:border-[#1e3a8a] hover:text-[#1e3a8a] hover:shadow-md"
      ...
      <main className="relative z-10 mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 pb-12 pt-4 lg:grid-cols-2 lg:gap-16 lg:pt-8">
        ...
        <section className="hidden flex-col items-center text-center lg:flex fade-up">
          <div className="relative">
            ...
            <Logo className="h-72 w-auto truck-drive" />
          </div>
          ...
          <ul className="mt-8 grid w-full max-w-md gap-3 text-start">
            {[tr.feature1, tr.feature2, tr.feature3].map((f, i) => (
              <li
                key={i}
                className="flex items-center gap-3 rounded-xl border border-slate-200/70 bg-white/60 px-4 py-3 text-sm font-medium text-slate-700 shadow-sm backdrop-blur"
              >
        ...
        <section className="flex justify-center fade-up">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-xl shadow-slate-200/60 backdrop-blur sm:p-10">
              ...
              <form onSubmit={onSubmit} className="space-y-5" noValidate>
                ...
                <div>
                  ...
                  <div
                    className={`group relative flex items-center rounded-xl border bg-white transition focus-within:border-[#1e3a8a] focus-within:ring-4 focus-within:ring-[#1e3a8a]/10 ${
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`w-full bg-transparent py-3 text-slate-900 placeholder:text-slate-400 focus:outline-none ${
                        isRTL ? "pr-11 pl-3 text-right" : "pl-11 pr-3"
                      }`}
                    />
                  </div>
                  {errors.email && (
                ...
                <div>
                  ...
                  >
                    ...
                    <button
                      ...
                      aria-label={showPass ? tr.hidePassword : tr.showPassword}
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <a
                    href="#"
                    className="font-semibold text-[#1e3a8a] transition hover:text-[#172554] hover:underline"
                  >
                    {tr.forgot}
                  </a>
                </div>
                ...
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-300 bg-white py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-50"
                >
              ...
              <p className="mt-7 text-center text-sm text-slate-600">
                ...
                <a
                  href="#"
                  className="font-bold text-[#1e3a8a] transition hover:text-[#172554] hover:underline"
                >
                  {tr.createAccount}
                </a>
              </p>
            ...
            <p className="mt-6 text-center text-xs text-slate-400">{tr.rights}</p>
          </div>
        </section>
      </main>
    </div>
